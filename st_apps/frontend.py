...
option12 = st.selectbox("Do you have any kind of health care converage, including health insurance, prepaid pland, etc?", ("Yes", "No"))
...
option14 = st.selectbox("Would you say that in general you health is:\n\n(1-excellent, 2-very good, 3-good, 4-fair, 5-poor)", (1,2,3,4,5))
